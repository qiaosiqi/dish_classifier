...
```bash
# 运行预测
python segment/resnet_predict.py --weights yolov5m-seg.pt --source data/images/bus.jpg
```
...
```bash
# 运行预测
python classify/resnet_predict.py --weights yolov5s-cls.pt --source data/images/bus.jpg
```
